...
<form action="${pageContext.request.contextPath}/servlet" method="post" class="form-signin"
    ...
    <input type="text" id="firstName" name="firstName" class="form-control"
           placeholder="<fmt:message key="registration.first.name"/>" value="${param.firstName}" required autofocus>
    ...
    <input type="text" id="middleName" name="middleName" class="form-control"
           placeholder="<fmt:message key="registration.middle.name"/>" value="${param.middleName}" required>
    ...
    <input type="text" id="lastName" name="lastName" class="form-control"
           placeholder="<fmt:message key="registration.last.name"/>" value="${param.lastName}" required>
    ...
    <input type="text" id="login" name="login" class="form-control"
           placeholder="<fmt:message key="registration.login"/>" value="${param.login}" required>
    ...
    <input type="text" id="password" name="password" class="form-control"
           placeholder="<fmt:message key="registration.password"/> " value="${param.password}" required>
