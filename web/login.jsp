...
<form class="form-signin" action="${pageContext.request.contextPath}/servlet" method="post"
    ...
    <input type="text" id="inputEmail" name="login" class="form-control" placeholder="<fmt:message key="login.login"/>"
    ...
    <input type="password" id="inputPassword" name="password" class="form-control"
           placeholder="<fmt:message key="login.password"/>" value="${param.password}" required>
